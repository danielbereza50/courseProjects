...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-154961127-4"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-154961127-4');
</script>
...
body.login div#login h1 a {
 background-image: url(/wp-content/uploads/2020/02/footer_logo_2.png); 
padding-bottom: 50px; 
} 
</style>
 <?php 
